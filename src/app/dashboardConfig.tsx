...
const lgLayouts: Layout[] = [
  ...
  { i: "sticky-notes", x: 0, y: 7, w: 6, h: 6, minW: 3, minH: 5 },
];
...
export const defaultLayouts: Layouts = {
  ...
  md: [
    ...
    { i: "sticky-notes", x: 0, y: 12, w: 10, h: 6, minW: 4, minH: 5 },
  ],
  sm: [
    { i: "clock", x: 0, y: 0, w: 3, h: 5, minW: 2, minH: 4 },
    { i: "memo", x: 3, y: 0, w: 3, h: 5, minW: 2, minH: 4 },
    ...
    { i: "sticky-notes", x: 0, y: 12, w: 6, h: 6, minW: 3, minH: 5 },
  ],
  xs: [
    ...
    { i: "sticky-notes", x: 0, y: 24, w: 4, h: 6, minW: 4, minH: 5 },
  ],
  xxs: [
    ...
    { i: "sticky-notes", x: 0, y: 24, w: 2, h: 6, minW: 2, minH: 5 },
  ],
};
